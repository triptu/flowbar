...
export default function ConceptsReference() {
    ...
    const filtered =
        active === "all" ? CONCEPTS : CONCEPTS.filter((c) => c.cat === active);
    ...
    return (
        <section id="concepts" class="py-[100px] px-12 max-w-[1280px] mx-auto">
            ...
            <p class="text-[17px] text-text-dim max-w-[640px] leading-[1.8] mb-5">
                Key Swift and SwiftUI concepts used throughout Flowbar, explained
                with real examples from the codebase.
            </p>
            ...
            <div class="grid grid-cols-[repeat(auto-fill,minmax(360px,1fr))] gap-5 mt-6">
                {filtered.map((concept) => (
                    ...
                    >
                        ...
                        <h3 class="font-mono text-[15px] text-text mb-2">
                            {concept.title}
                        </h3>
                        <p class="text-[13px] text-text-dim mb-3 leading-[1.6]">
                            {concept.desc}
                        </p>
                        <pre
